...
?>
  <main class="main mainContact">
    <div class="main-heading">
      <h1 class="main-heading__title"><?php the_lang_word('common_7');?></h1>
    </div> <!-- /.main-heading -->
    <div class="main-container">
      <div class="main-content mainContact-content">
        ...
        <form action="/contact?lang=<?php echo get_lang();?>" method="post" role="form" class="contactUserForm">
          <p><?php the_lang_word('contact_9');?></p>
          <div class="contactUserForm-name contactUserForm-item">
            <label for="" class="control-label"><?php the_lang_word('contact_2');?></label>
            <input type="" name="contact[name]" value="<?php echo $contact['name'];?>" class="form-control" id="" placeholder="">
          ...
          <div class="contactUserForm-email contactUserForm-item">
            <label for="" class="control-label center-label"><?php the_lang_word('contact_3');?> <span class="require_mark">*</span></label>
          ...
          <div class="contactUserForm-subject contactUserForm-item">
            <label for="" class="control-label center-label"><?php the_lang_word('contact_4');?></label>
          ...
          <div class="contactUserForm-content contactUserForm-item">
            <label for="" class="control-label center-label"><?php the_lang_word('contact_5');?> <span class="require_mark">*</span></label>
          ...
          <div class="contactUserForm-submit contactUserForm-item">
            <input type="submit" value="<?php the_lang_word('contact_8');?>" name="submitbtn" class="contactUserForm-submit__input" id="contactUserForm-submit__input">
          </div>  
