  ...
  <footer class="footer">
      ...
      <div class="footer-breadList__container">
        <ul class="footer-breadList__list">
          <li class="footer-breadList__item d-inline-block">
            <a href="/?lang=<?php echo get_lang();?>" class="footer-breadList__link"><img src="assets/images/footer/logo_min.png" alt="footer-breadList__link-img"></a>
          </li>
    ...
    <div class="footer-businessLink">
      <div class="footer-businessLink__container">
        <a href="/?lang=<?php echo get_lang();?>" class="footer-businessLink__btn"><?php the_lang_word('common_1'); ?> <span class="footer-businessLink__btn-arrow"><img src="/assets/images/link_arrow_right_red.png"></span></a>
    ...
    <div class="footer-nav">
      <div class="footer-nav__container">
        <ul class="footer-nav__list">
          ...
          <li class="footer-nav__item d-md-inline-block">
            <a href="/biz-contact?lang=<?php echo get_lang();?>" class="footer-nav__link"><?php the_lang_word('common_6');?><img src="assets/images/footer/footer-nav__linkimg.png" alt="" class="footer-nav__linkimg"></a>
          </li>
          <li class="footer-nav__item d-md-inline-block">
    ...
    <div class="footer-logo">
      <div class="footer-logo__container">
        <a href="/biz-index?lang=<?php echo get_lang();?>" class="footer-logo__link"><img src="assets/images/footer/footer-logo__link-img.png" class="footer-logo__link-img"></a>
  ...
  <?php if (!isset($_SESSION['allow_cookies']['first'])) :?>
  <script type='text/javascript' src='/assets/js/cookieModal.js'></script>
  <?php endif;?>
</body>
</html>
